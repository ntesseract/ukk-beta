        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <div class="mb-4 md:mb-0">
                    <h1 class="text-3xl font-bold text-gray-900">List Siswa</h1>
                </div>
            
                <div class="hidden md:flex items-center gap-4">
                    <form class="flex-1" action="{{ route('siswas.index') }}" method="GET">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div 
                            ...
                            <div class="p-4 space-y-3">
                                <form action="{{ route('siswas.index') }}" method="GET" class="mb-3">
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    <div class="h-48 relative">
                        <img 
                            src="{{ $siswa->foto ? url('storage/' . $siswa->foto) : asset('default-avatar.jpg') }}" 
                            class="w-full h-full object-cover"
                            alt="{{ $siswa->namasiswa }}"
                            loading="lazy"
                        >
                        <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
                            <h3 class="text-xl font-bold text-white">{{ $siswa->namasiswa }}</h3>
                            <p class="text-sm text-blue-200">{{ $siswa->nis }}</p>
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-sm {{ $siswa->jeniskelamin == 'L' ? 'text-blue-600' : 'text-pink-600' }}">
                        ...
                        <div class="flex gap-2 border-t pt-3">
                            <button 
                                ...
                                data-bs-toggle="modal" 
                                data-bs-target="#detailSiswaModal{{ $siswa->nis }}">
                            ...
                            <button 
                                ...
                                data-bs-toggle="modal" 
                                data-bs-target="#deleteSiswaModal{{ $siswa->nis }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="modal fade" id="detailSiswaModal{{ $siswa->nis }}" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content rounded-xl overflow-hidden border-0">
                            <div class="modal-header bg-gradient-to-r from-blue-600 to-blue-500 p-6">
                                <h5 class="text-xl font-bold text-white">Detail Siswa</h5>
                                ...
                                <div class="flex flex-col md:flex-row gap-8">
                                    ...
                                    <div class="md:w-1/3">
                                        ...
                                        <button 
                                            ...
                                            data-bs-toggle="modal" 
                                            data-bs-target="#editSiswaModal{{ $siswa->nis }}">
                                            ✏️ Edit Profil
                                        </button>
                                    </div>
                                    <div class="md:w-2/3 space-y-4">
                                        <div>
                                            ...
                                            <p class="text-xl font-semibold text-gray-800">{{ $siswa->namasiswa }}</p>
                                        </div>
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label class="text-sm font-medium text-gray-500">TTL</label>
                                                <p class="text-gray-800">
                                                    {{ date('d F Y', strtotime($siswa->ttl)) }}
                                                </p>
                                            </div>
                                            <div>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-800 whitespace-pre-line">{{ $siswa->alamat }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <!-- ini Edit  -->
                <div class="modal fade" id="editSiswaModal{{ $siswa->nis }}" tabindex="-1">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content rounded-xl">
                            <div class="modal-header bg-gradient-to-r from-blue-600 to-blue-500 p-6">
                                <h5 class="text-xl font-bold text-white">Edit Data Siswa</h5>
                                <button type="button" class="text-white opacity-75 hover:opacity-100" data-bs-dismiss="modal">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                            ...
                            <form action="{{ route('siswas.update', $siswa->nis) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="modal-body p-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div class="md:col-span-1">
                                                ...
                                                <div class="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity rounded-xl">
                                                    <label class="cursor-pointer text-white">
                                                        <input 
                                                            ...
                                                            class="hidden"
                                                            accept="image/*"
                                                            onchange="document.getElementById('previewFoto{{ $siswa->nis }}').src = window.URL.createObjectURL(this.files[0])">
                                            ...
                                            <label class="flex items-center justify-center mt-3 px-4 py-2 bg-gray-100 text-gray-700 rounded-lg cursor-pointer hover:bg-gray-200 transition-colors">
                                                <input 
                                                    type="file" 
                                                    name="foto" 
                                                    class="hidden"
                                        ...
                                        <div class="md:col-span-1 space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <textarea 
                                                    name="alamat"
                                                    class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 h-32"
                ...
                <!-- ini hapus -->
                <div class="modal fade" id="deleteSiswaModal{{ $siswa->nis }}" tabindex="-1">
                        ...
                        <div class="modal-content rounded-xl">
                            ...
                            <div class="modal-body p-6">
                                <div class="text-center">
                                    ...
                                    <h3 class="text-lg font-medium text-gray-900 mb-2">Hapus Data Siswa?</h3>
                                    <p class="text-gray-500">Data {{ $siswa->namasiswa }} ({{ $siswa->nis }}) akan dihapus permanen.</p>
                                </div>
                            </div>
                            <div class="modal-footer p-6 border-t border-gray-200">
                                <form action="{{ route('siswas.destroy', $siswa->nis) }}" method="POST" class="w-full">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="modal fade" id="addSiswaModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content rounded-xl">
                        <div class="modal-header bg-gradient-to-r from-blue-600 to-blue-500 p-6">
                            <h5 class="text-xl font-bold text-white">Tambah Siswa Baru</h5>
                            <button type="button" class="text-white opacity-75 hover:opacity-100" data-bs-dismiss="modal">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                </svg>
                        ...
                        <form action="{{ route('siswas.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer p-6 border-t border-gray-200">
                                <button type="button" class="px-6 py-2.5 text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200" data-bs-dismiss="modal">Batal</button>
                                <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 ml-2">Simpan Siswa</button>
                            </div>
                        </form>
                    </div>
                </div>
